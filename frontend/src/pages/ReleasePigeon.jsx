...
function ReleasePigeon() {
  ...
  return (
    ...
    >
      ...
      <div className={`w-full max-w-2xl bg-black/60 dark:bg-gray-900/80 text-white flex flex-col mx-auto py-12 px-4 rounded-lg shadow-lg transition-opacity duration-300 ${isReleasing ? 'opacity-0' : 'opacity-100'} z-20`}>
      ...
      {/* CSS animations - Increased scale values for bigger animation */}
      <style>{`
